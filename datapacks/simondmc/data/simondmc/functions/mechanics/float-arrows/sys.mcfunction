...
execute as @a[nbt={SelectedItem:{id:"minecraft:carrot"}}] unless score $end elevator matches 0..362 run effect give @s levitation 1 3 true
execute as @a[nbt=!{SelectedItem:{id:"minecraft:carrot"}}] unless score $end elevator matches 0..362 run effect clear @s levitation
