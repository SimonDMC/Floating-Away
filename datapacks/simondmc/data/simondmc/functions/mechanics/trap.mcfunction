...
execute if score $anim trap matches 0 run playsound block.anvil.place master @a 4 54 53 1 2
execute if score $anim trap matches 5 run clone 1 69 51 7 70 55 1 53 51
execute if score $anim trap matches 5 run playsound block.anvil.place master @a 4 54 53 1 2
execute if score $anim trap matches 10 run clone 1 72 51 7 73 55 1 53 51
execute if score $anim trap matches 10 run playsound block.anvil.place master @a 4 54 53 1 2
# open
execute if score $anim trap matches 15 run fill 1 53 51 7 54 55 air
execute if score $anim trap matches 15 run playsound block.anvil.place master @a 4 54 53 1 2