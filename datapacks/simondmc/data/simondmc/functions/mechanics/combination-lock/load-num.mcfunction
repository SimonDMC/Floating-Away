...
execute unless entity @s[tag=button-R] unless entity @s[tag=button-B] run playsound minecraft:ui.button.click master @a[tag=playing] 21 86 -33 1 2
execute if entity @s[tag=button-R] run playsound minecraft:ui.button.click master @a[tag=playing] 21 86 -33
execute if entity @s[tag=button-B] run playsound minecraft:ui.button.click master @a[tag=playing] 21 86 -33