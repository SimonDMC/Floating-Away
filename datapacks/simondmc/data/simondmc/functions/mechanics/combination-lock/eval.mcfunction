...
execute if score $1 combinationlock matches 6 if score $2 combinationlock matches 8 if score $3 combinationlock matches 7 if score $4 combinationlock matches 9 as @a[tag=playing] at @s run playsound entity.experience_orb.pickup master @s
...
execute unless score $correct combinationlock matches 1 as @a[tag=playing] at @s run playsound block.note_block.didgeridoo master @s
