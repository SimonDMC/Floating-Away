...
execute if score $anim powersource matches 1 run playsound block.beacon.activate master @a 49 89 -25 1 0
...
execute if score $anim powersource matches 7 run playsound block.beacon.activate master @a 49 89 -25 1 0
