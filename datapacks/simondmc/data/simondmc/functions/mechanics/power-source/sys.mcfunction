...
execute if score $anim powersource matches 1 run playsound block.beacon.activate master @a[tag=playing] 49 89 -25 1 0
...
execute if score $anim powersource matches 4 run stopsound @a[tag=playing] master block.beacon.activate
...
execute if score $anim powersource matches 7 run playsound block.beacon.activate master @a[tag=playing] 49 89 -25 1 0
