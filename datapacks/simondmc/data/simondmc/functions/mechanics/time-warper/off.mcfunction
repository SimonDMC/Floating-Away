...
# replace item
execute as @a[tag=playing,nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick"}}] run item modify entity @s weapon.mainhand simondmc:time-warper/off
execute as @a[tag=playing,nbt={Inventory:[{id:"minecraft:carrot_on_a_stick",Slot:-106b}]}] run item modify entity @s weapon.offhand simondmc:time-warper/off
# speed up music
execute if score $last-area timewarper matches 1 unless score $disallowed timewarper matches 1 run stopsound @a[tag=playing] ambient
execute if score $last-area timewarper matches 1 unless score $disallowed timewarper matches 1 as @a[tag=playing] at @s run playsound music.out-of-order-speeding ambient @s
execute if score $last-area timewarper matches 1 unless score $disallowed timewarper matches 1 run scoreboard players reset $track-4-timer music
