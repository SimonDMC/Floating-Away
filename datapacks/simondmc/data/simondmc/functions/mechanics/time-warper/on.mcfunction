...
# slow down music
execute if predicate simondmc:time-warper-decommissioned run stopsound @a[tag=playing] ambient
execute if predicate simondmc:time-warper-decommissioned as @a[tag=playing] at @s run playsound music.out-of-order-slowing ambient @s
execute if predicate simondmc:time-warper-decommissioned run scoreboard players reset $track-4-timer music
execute if predicate simondmc:time-warper-chase run stopsound @a[tag=playing] ambient
execute if predicate simondmc:time-warper-chase as @a[tag=playing] at @s run playsound music.floating-away-quartz-slowing ambient @s
