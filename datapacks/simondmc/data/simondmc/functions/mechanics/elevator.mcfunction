...
execute if score $start elevator matches 1 run tp @a[predicate=!simondmc:first-elevator] @r[predicate=simondmc:first-elevator]
...
execute if score $start elevator matches 121 as @a at @s run playsound music.ground-level ambient @s
