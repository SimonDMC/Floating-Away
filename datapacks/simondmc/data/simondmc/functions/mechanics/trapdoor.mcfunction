...
execute as @e[tag=trapdoor-lever-int] if data entity @s interaction unless score $closed trapdoor matches 1 run playsound minecraft:block.iron_trapdoor.close block @a -14 71 31
execute as @e[tag=trapdoor-lever-int] if data entity @s interaction unless score $closed trapdoor matches 1 run playsound minecraft:block.lever.click block @a -14 68 31
