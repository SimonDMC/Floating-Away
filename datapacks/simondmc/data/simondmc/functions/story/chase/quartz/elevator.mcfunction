...
execute if score $track-67-timer music matches 1 as @a at @s run tp @s ~ 38 ~
execute if score $track-67-timer music matches 1 run effect give @a jump_boost 1 200 true
# elevate player
execute if score $track-67-timer music matches 1 run effect give @a levitation infinite 1 true
execute if score $track-67-timer music matches 1..313 as @a[x=-6.0,y=66.7,z=-8.0,dy=1,dx=3,dz=3] run effect clear @s levitation
# elevate blocks
...
execute if score $track-67-timer music matches 306 as @a if predicate simondmc:in-elevator run tp @s -4.5 65 -6.5 90 0
...
execute if score $track-67-timer music matches 306 run effect clear @a levitation