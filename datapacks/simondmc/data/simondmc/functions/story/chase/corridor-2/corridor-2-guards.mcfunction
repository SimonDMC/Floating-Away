...
execute if score $corridor-anim-2 guards matches 150.. as @a if predicate simondmc:corridor-2 run damage @s 100 mob_attack by @e[tag=corridor-2-guard,limit=1]
...
execute if score $corridor-anim-2 guards matches 200 unless score $closed trapdoor matches 1 as @a if predicate simondmc:pit-1-tunnel run damage @s 100 mob_attack by @e[tag=corridor-2-guard,limit=1]
