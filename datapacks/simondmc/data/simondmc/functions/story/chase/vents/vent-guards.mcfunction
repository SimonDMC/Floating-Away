...
execute as @a if predicate simondmc:vent-guards unless score $vent-guards guards matches 1 run summon armor_stand 1 108 -18 {Tags:["character","guard","vent-guard"],Rotation:[90f,0f],Invulnerable:1b,Invisible:1b,DisabledSlots:4144959,ArmorItems:[{},{},{},{id:"minecraft:black_candle",Count:1b,tag:{CustomModelData:1}}],HandItems:[{id:"minecraft:bow",Count:1b},{}]}
execute as @a if predicate simondmc:vent-guards unless score $vent-guards guards matches 1 run summon armor_stand 1 108 -17 {Tags:["character","guard","vent-guard"],Rotation:[90f,0f],Invulnerable:1b,Invisible:1b,DisabledSlots:4144959,ArmorItems:[{},{},{},{id:"minecraft:black_candle",Count:1b,tag:{CustomModelData:1}}],HandItems:[{id:"minecraft:bow",Count:1b},{}]}
execute as @a if predicate simondmc:vent-guards unless score $vent-guards guards matches 1 run summon armor_stand 1 108 -16 {Tags:["character","guard","vent-guard"],Rotation:[90f,0f],Invulnerable:1b,Invisible:1b,DisabledSlots:4144959,ArmorItems:[{},{},{},{id:"minecraft:black_candle",Count:1b,tag:{CustomModelData:1}}],HandItems:[{id:"minecraft:bow",Count:1b},{}]}
...
execute as @a if predicate simondmc:vent-guards unless score $vent-guards guards matches 1 run scoreboard players reset $machine-gun guards
