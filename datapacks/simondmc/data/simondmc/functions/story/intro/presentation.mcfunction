...
execute if score $intro-anim presentation matches 84 run tellraw @a ["",{"text":"[Boss]:","color":"dark_aqua"},{"text":" Hello everyone! I\u2019m so excited to be here today and we promise this will be worth your time.","color":"gray"}]
execute if score $intro-anim presentation matches 205 run tellraw @a ["",{"text":"[Boss]:","color":"dark_aqua"},{"text":" I\u2019m standing here on behalf of Folio Industries to show you the latest and greatest technology we\u2019ve been working on for the past decade.","color":"gray"}]
execute if score $intro-anim presentation matches 369 run tellraw @a ["",{"text":"[Boss]:","color":"dark_aqua"},{"text":" I truly believe we\u2019ve got something special on our hands that will revolutionize the way we interact with our world. Here\u2019s what we\u2019ve been working on.","color":"gray"}]
execute if score $intro-anim presentation matches 528 run tellraw @a ["",{"text":"[Boss]:","color":"dark_aqua"},{"text":" These are Float Arrows. There\u2019s two of them and each one is special in its own way.","color":"gray"}]
...
execute if score $intro-anim presentation matches 632 run tellraw @a ["",{"text":"[Boss]:","color":"dark_aqua"},{"text":" We\u2019ve got the up arrow, which makes you slowly float upwards when you hold it. And then we\u2019ve got the down arrow, which makes you slowly float downwards.","color":"gray"}]
...
execute if score $intro-anim presentation matches 781 run tellraw @a ["",{"text":"[Boss]:","color":"dark_aqua"},{"text":" Our research team has found a way to pack so much technology into these little accessories that we\u2019re able to generate a force stronger than gravity.","color":"gray"}]
execute if score $intro-anim presentation matches 953 run tellraw @a ["",{"text":"[Boss]:","color":"dark_aqua"},{"text":" Now, this is an extremely powerful technology, but it\u2019s our job to be careful and responsible with who we give access to it.","color":"gray"}]
...
execute if score $intro-anim presentation matches 1097 run tellraw @a ["",{"text":"[Boss]:","color":"dark_aqua"},{"text":" It\u2019s not yet ready for production, but we wanted to demo it to show what\u2019s possible. Let\u2019s take a little break and I\u2019ll answer some questions afterwards.","color":"gray"}]
execute if score $intro-anim presentation matches 1260 run fill 61 105 -45 61 107 -45 air
execute if score $intro-anim presentation matches 1260 run playsound block.chain.break master @a 61 105 -45 1 0
...
execute if score $intro-anim presentation matches 1280 run playsound block.chain.break master @a 61 105 -45 1 0
