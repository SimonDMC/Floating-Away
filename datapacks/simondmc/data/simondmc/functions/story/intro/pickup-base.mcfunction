...
execute if score $tutorial-phase work matches 2 on attacker if entity @s[nbt={Inventory:[{id:"minecraft:feather",tag:{CustomModelData:2}}]}] run scoreboard players set $tutorial-phase work 3